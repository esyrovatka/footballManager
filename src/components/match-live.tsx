  ...
  return (
    <div className="space-y-6">
              ...
              <div className="mt-2 flex items-center gap-1">
                <span
                  className={`inline-block w-1.5 h-1.5 rounded-full ${
                    connected ? 'bg-green-500 animate-pulse' : 'bg-neutral-400'
                  }`}
                />
                <span className="text-[10px] uppercase text-neutral-500 tracking-wide">
      ...
      <section>
        ...
        <div
          ref={feedRef}
          className="rounded-lg border border-neutral-200 dark:border-neutral-800 max-h-[60vh] overflow-y-auto"
        >
